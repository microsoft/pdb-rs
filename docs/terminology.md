...
`ItemId`
: A 32-bit integer which identifies a record in the [IPI Stream](pdb/ipi.md).
...
`NameIndex`
: A 32-bit integer which identifies a string stored in the [Names Stream](pdb/names_stream.md).
